...
export function Hints({crystals, onShuffle, onShowWords, onShowMask} : IHintsProps) {
  ...
  return (
    <div className="hints">
      ...
      <button className="btn hints__button hints__button--show-words" disabled={crystals < 0} onClick={() => {
        onShowWords();
      }}>
        show words
      </button>
      <button className="btn hints__button hints__button--show-mask" disabled={crystals < 0} onClick={() => {
        onShowMask();
      }}>
        show mask
      </button>
